...
public class MotionSensorsPlusPlugin: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance = MotionSensorsPlusPlugin(registrar: registrar)
                ...
                if let data = data {
                    DispatchQueue.main.async {
                        ...
                        if self.attitudeReferenceFrame == CMAttitudeReferenceFrame.xMagneticNorthZVertical {
                            ...
                            events([data.attitude.pitch, data.attitude.roll, yaw])
                        } else {
                            events([data.attitude.pitch, data.attitude.roll, data.attitude.yaw,])
                        }
                    }
                }
            }
